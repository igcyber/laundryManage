...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2021 at 11:02 AM
...
(1, 'Laundry Jaya', 'Jl. Sana Sini Capek', '08534618907');
...
--
ALTER TABLE `tb_paket`
  ADD CONSTRAINT `tb_paket_ibfk_1` FOREIGN KEY (`id_oulet`) REFERENCES `tb_outlet` (`id`);
